...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        // Write new user
        writeNewUser(user.getUid(), email ,firstname, phonenumber, "Alamat Lengkap", "Provinsi", "Kota", "Kecamatan", "Kode Pos");
        // Go to MainActivity
    ...
    private void writeNewUser(String userId, String email, String firstname, String phonenumber, String alamat, String provinsi, String kota, String kecamatan, String kodepos) {
